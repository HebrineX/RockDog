...
CREATE TABLE `rockdog_rockdog`.`marcas` (
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `marca` VARCHAR(255) NOT NULL
);

CREATE TABLE `rockdog_rockdog`.`productos` (
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `rockdog_rockdog`.`categorias` (
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `categoria` VARCHAR(255) NOT NULL
);

CREATE TABLE `rockdog_rockdog`.`usuarios` (
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `rockdog_rockdog`.`productos_usuarios` (
...
CREATE TABLE `rockdog_rockdog`.`compras` (
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `ID_usuario` INT NOT NULL,
  `total` INT NOT NULL,
...
CREATE TABLE `rockdog_rockdog`.`productos_compras` (
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
